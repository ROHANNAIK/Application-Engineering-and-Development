...
public class BrowseProducts extends javax.swing.JPanel {
 ...
 private boolean isCheckedOut =false;
    ...
    public BrowseProducts(JPanel userProcessContainer, SupplierDirectory supplierDirectory, MasterOrderCatalog moc) {
        initComponents();
    ...
    public void populateSupplierCombo()
    {
        ...
        for(Suppliers s : supplierDirectory.getSupplierdirectory())
        {
...
{ 
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 230, 680, 100));
        ...
        add(suppComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 130, 250, -1));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Supplier");
        jLabel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 110, 30));
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 180, 590, 40));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 740, 140, 40));

        viewProdjButton2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        add(viewProdjButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 350, 180, 40));
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, 780, 80));
        ...
        add(addtoCartButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 350, 130, 40));

        quantitySpinner.setModel(new javax.swing.SpinnerNumberModel(0, 0, null, 1));
        add(quantitySpinner, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 350, 40, 40));
        ...
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 350, 90, 40));
        ...
        add(btnSearchProduct, new org.netbeans.lib.awtextra.AbsoluteConstraints(693, 130, 170, 30));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 350, 110, 40));
        add(txtSalesPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 350, 50, 40));
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 410, 610, 40));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 470, 730, 170));

        btnViewOrderItem.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        ...
        btnViewOrderItem.setCursor(new java.awt.Cursor(java.awt.Cursor.MOVE_CURSOR));
        btnViewOrderItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnViewOrderItemActionPerformed(evt);
            }
        });
        add(btnViewOrderItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(165, 659, 110, 40));

        btnModifyQuantity.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        add(btnModifyQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 660, 130, 40));

        btnRemoveOrderItem.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        ...
        add(btnRemoveOrderItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 659, 100, 40));
        ...
        add(btnCheckOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 740, 140, 40));
        add(txtSearchKeyWord, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 130, 150, 30));
        ...
        add(txtNewQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 660, 70, 40));
