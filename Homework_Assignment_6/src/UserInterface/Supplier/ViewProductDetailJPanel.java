...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 200, 40));

        txtPrice.setEditable(false);
        txtPrice.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtPrice.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        add(txtPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 340, 230, 40));
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 410, 200, 40));

        availjTextField.setEditable(false);
        add(availjTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 410, 230, 40));
